...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, config, options, document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    document = swagger_1.SwaggerModule.createDocument(app, config, options);
                    fs.writeFileSync("./swagger.yaml", yaml.stringify(document));
                    swagger_1.SwaggerModule.setup('api', app, document);
                    app.useStaticAssets(path_1.join(__dirname, '..', 'public')); // serve static files from the public folder
                    app.setBaseViewsDir(path_1.join(__dirname, '..', 'views')); // set the base directory for templates
                    app.setViewEngine('hbs');
                    return [4 /*yield*/, app.listen(process.env.APP_PORT || 3000)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
