...
var EvaluationController = /** @class */ (function () {
    ...
    EvaluationController.prototype.getEvaluationData = function (user, inspectionId) {
        return __awaiter(this, void 0, Promise, function () {
            var inspection, blocs, criteria;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.inspectionService.getInspectionById(user, inspectionId)];
                    case 1:
                        inspection = _a.sent();
                        return [4 /*yield*/, this.blocService.getBlocksByUnit(inspection.unit.id)];
                    case 2:
                        blocs = _a.sent();
                        return [4 /*yield*/, this.evaluationPointService.getPointsByType(inspection.type)];
                    case 3:
                        criteria = _a.sent();
                        return [2 /*return*/, {
