...
var UserSubscribeDto = /** @class */ (function () {
    ...
    ], UserSubscribeDto.prototype, "username");
    __decorate([
        swagger_1.ApiProperty({
        ...
        swagger_1.ApiPropertyOptional()
    ], UserSubscribeDto.prototype, "email");
    __decorate([
        swagger_1.ApiProperty({
        ...
        class_validator_1.IsOptional(),
        swagger_1.ApiPropertyOptional()
    ], UserSubscribeDto.prototype, "tel");
    __decorate([
        swagger_1.ApiProperty({
        ...
        swagger_1.ApiPropertyOptional()
    ], UserSubscribeDto.prototype, "role");
    __decorate([
        swagger_1.ApiProperty({
        ...
        class_validator_1.IsOptional(),
        swagger_1.ApiPropertyOptional()
    ], UserSubscribeDto.prototype, "password");
